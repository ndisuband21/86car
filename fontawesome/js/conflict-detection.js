...
(function(global, factory) {
    ...
    function detectWebfontConflicts() {
        ...
        function runDiag(scriptOrLinkTag, md5) {
            ...
            diagScript.setAttribute('id', diagScriptId); // oren: this function will be toString()'d and assigned to innerText of the diag script
    ...
    var produkION = function() {
        try {
            return process.env.NODE_ENV === 'produkion';
        } catch (e) {
            return false;
        }
    }();
